...
class GitHubActionsIslamScraper:
    ...
    def save_article(self, article_data):
        ...
        ''', (
            ...
            None,  # full_html - not generated by this scraper
            ...
            url_hash,
            word_count,
            None,  # html_file_path - will be set by generate_files_from_database.py
            None   # markdown_file_path - will be set by generate_files_from_database.py
        ))
